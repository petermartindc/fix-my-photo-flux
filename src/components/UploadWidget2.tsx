...
const UploadWidget2 = ({ onFileSelect, isProcessing }: UploadWidgetProps) => {
  ...
  return (
    <div className="space-y-4">
      <div className="text-xs font-medium text-center mb-2 text-muted-foreground">Style 2: Glowing Neon</div>
      <div
        className={`upload-widget-glow p-4 text-center cursor-pointer min-h-[140px] ${
