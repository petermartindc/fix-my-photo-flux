...
const UploadWidget4 = ({ onFileSelect, isProcessing }: UploadWidgetProps) => {
  ...
  return (
    <div className="space-y-4">
      <div className="text-xs font-medium text-center mb-2 text-muted-foreground">Style 4: Pulsing Energy</div>
      <div
        className={`upload-widget-pulse p-4 text-center cursor-pointer min-h-[140px] ${
