...
const UploadWidget1 = ({ onFileSelect, isProcessing }: UploadWidgetProps) => {
  ...
  return (
    <div className="space-y-4">
      <div className="text-xs font-medium text-center mb-2 text-muted-foreground">Style 1: Undulating Wave</div>
      <div
        className={`upload-widget-wave p-4 text-center cursor-pointer min-h-[140px] ${
